...
return (
  <>
    ...
    <Button variant={completed ? "outline" :"solid"} _text={{color:'white'}} onPress={async () => ToggleHabitCompleted(props.ID, setrefreshToken)} onLongPress={() =>       setModalVisible(true)}>{props.Name}</Button></>)
}