...
return (
  <>
    ...
    <Button variant={completed ? "outline" :"solid"} onPress={async () => ToggleHabitCompleted(props.ID, setrefreshToken)} onLongPress={() =>       {setModalVisible(true), console.log('longpress')}}>{props.Name}</Button></>)
}